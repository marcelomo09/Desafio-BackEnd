...
public class CreateMotorcycleRentalRequest
{
    ...
    [Required(ErrorMessage = "Data de inicio da locação não informada")]
    ...
    [CompareDatesMoreOrLessThen("StartDate", ErrorMessage = "Data final não pode ser menor que a data inicial.")]
